    ...
    return (
        <form id="joinForm" name="joinForm" method="post" action="/do/not/post">
            ...
            { email === '' ?
                null : 
                validEmail ?  
                    <FontAwesomeIcon icon={faCheckCircle} style={{fontSize:16, color:'green', marginLeft: 2}}/> : 
                    <FontAwesomeIcon icon={faTimesCircle} style={{fontSize:16, color:'red', marginLeft: 2}}/> 
            }
